...
public class ExDeckViewScreen extends CustomScreen implements ScrollBarListener {
    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString(makeID(ExDeckViewScreen.class.getSimpleName()));
    public static final String[] TEXT = ExDeckViewScreen.tutorialStrings.TEXT;
    ...
    Logger logger = new Logger(ExDeckViewScreen.class.getName());

    public ExDeckViewScreen() {
        // 初始化UI布局
    ...
    private void open(ExDeckCardGroup nobleCards) {
        reopen();
        // 保存传入的卡组
